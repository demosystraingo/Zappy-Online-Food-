...
function call(){
	...
	if(pass.type=="password"&&cpass.type=="password"){
		pass.type="text";cpass.type="text";
	}else{
		pass.type="password";cpass.type="password"
	}
}
</script>
				...
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="SignUp" method="post">
					  ...
					  <input type="email" name="email" placeholder="Email Address" required=" " pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
					  <input type="text" name="mob" placeholder="Phone Number" required=" " pattern="[789][0-9]{9}" maxlength="10">
					  <textarea name="add" placeholder="   Address" required=" " style="height:100px;width:320px"></textarea><br/><br/>
					  <input type="password" name="pwd" id ="pass" placeholder="Password" required=" ">
					  <input type="password" name="cpwd" id = "cpass" placeholder="Confirm-Password" onblur="show()" required=" ">
					  <input type="checkbox" onclick="call()" />Show Password<br/><br/>
