...
<!-- //header -->
<!-- banner --><div class="products-breadcrumb">
		<div class="container">
			<ul>
...
<tr><th>Name</th><th>Last_Name</th><th>Mobile_No</th><th>Address</th><th>Email</th></tr>
<%
ArrayList<CustomerBean> list; 
list = (ArrayList<CustomerBean>)request.getAttribute("customer");

for(CustomerBean b : list){
%>
<tr>
<td><%out.println(b.getName()); %></td>
<td><%out.println(b.getLastname()); %></td>
<td><%out.println(b.getMob()); %></td>
