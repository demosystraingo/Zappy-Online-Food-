...
<!-- header -->
	<div class="agileits_header">
		<div class="w3l_offers">
			<a href="products.html">Today's special Offers !</a>		</div>
		...
		<div class="container">
			...
			<!-- <div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="ViewCustomer">Services</a></li>
				</ul>
			</div> -->
			<div class="w3ls_logo_products_left1">
...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="adminlogin.jsp">Home</a><span>|</span></li>
				...
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="AdminPassword" method="post">
					  <input type="text" name="uid" placeholder="Enter Your Email-id" required=" ">
