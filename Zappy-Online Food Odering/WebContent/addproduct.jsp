				  ...
				  <div class="form">
					...
					<form action="AddProduct" method="post" enctype="multipart/form-data">
					  <input type="text" name="pname" placeholder="Product Name" required=" ">
					   <select name="category" style="width: 322px; height:45px" >
					   <option>-------Select Category-------</option>
  								<option value="ready to eat">Ready To Eat</option>
  								<option value="ready to drink">Ready To Drink</option>
 								 <option value="ready to cook">Ready To Cook</option>
																				</select> <br/><br/>
					  <input type="text" name="price" placeholder="Product Rate" required=" ">
					  <input type="text" name="weight" placeholder="Product Weight" required=" ">
					  
					  <input type="text" name="discription" placeholder="Add Discription" required=" ">
					  Add Image<input type="file" name="image" placeholder="Add Image" accept=".jpg"><br/>
