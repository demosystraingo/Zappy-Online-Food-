						...
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li>
									...
									%> Welcome <%=name%> <br /> <a href="Logout">Logout</a> <a
									href="mydemo.jsp">Change Password</a>
								</li>
							</ul>
						</div>
					</div></li>
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1>
					<a href="#"><span>Grocery</span> ZAPPY </a>
				</h1>
			</div>
			   ...
			   Collect the nav links, forms, and other content for toggling
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<li><a href="kitchen.html">View Pending Orders</a></li>
						<li><a href="short-codes.html">View All Order History</a></li>
						<li><a href="ViewCustomer">View All Registered Customer</a></li>
						< li class="dropdown">
		...
		<section class="slider">
			<div class="w3_login_module">
				<div class="module form-module">
					...
					<div class="form">
						<h2>User Profile</h2>
						<form action="ViewPendingPacket" method="post">
							<input type="text" name="fname" placeholder="First Name"
								value="<%=b.getName()%>" readonly required=" "> <input
								type="text" name="lname" readonly placeholder="Last Name"
								value="<%=b.getLastname()%>" readonly required=" "> <input
								type="email" name="email" readonly placeholder="Email Address"
								value="<%=b.getEmail()%>" readonly required=" "
								pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"> <input
								type="text" name="mob" readonly placeholder="Phone Number" required=" "
								value="<%=b.getMob()%>" readonly pattern="[789][0-9]{9}" maxlength="10">
							<textarea name="add" placeholder="   Address" required=" " readonly
								style="height: 100px; width: 320px" value="<%=b.getAddress()%>"><%=b.getAddress()%></textarea>
								<br /> <br />
