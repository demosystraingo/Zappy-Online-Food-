...
<!-- header -->
	<div class="agileits_header">
		<div class="w3l_offers">
			<a href="Index">Today's special Offers !</a>
		</div>
		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					<center><h6>READY TO DRINK </h6></center>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="Single?pid=<%=b.getPid()%>"><img src="imgupload/<%=b.getImage()%>" alt=" " class="img-responsive" /></a>
											<p><%=b.getProductName()%> (<%=b.getWeight() %>)</p>
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					<center><h6>Ready TO COOK </h6></center>
					<%/* ArrayList<ZappyBean> al=(ArrayList<ZappyBean>)request.getAttribute("products"); 
					if(al==null){
						response.sendRedirect("Index");
					}
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					<center><h6>Ready To Eat </h6></center>
					<%/* ArrayList<ZappyBean> al=(ArrayList<ZappyBean>)request.getAttribute("products"); 
					if(al==null){
						response.sendRedirect("Index");
					}
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list"><li><a href="kitchen.html">Kitchen</a></li>
			...
			<div class="wthree_footer_copy">
				<p>© 2018 Zappy Store. All rights reserved | Design by <a href="https://www.facebook.com/profile.php?id=100003667232061">Mustafa</a></p>
			</div>
		</div>
</div>
<!-- //footer -->
