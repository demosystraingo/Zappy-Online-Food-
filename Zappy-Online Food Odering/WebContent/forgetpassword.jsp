					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li><a href="login.jsp?pagename=Index">Login</a></li> 
								<li><a href="login.jsp?pagename=Index">Sign Up</a></li>
							</ul>
						</div>                  
					</div>	
				</li>
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com">mustafaalii784@gmail,com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
