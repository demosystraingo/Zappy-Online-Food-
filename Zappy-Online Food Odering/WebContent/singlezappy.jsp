		...
		<div class="product_list_header">  
			<form action="CheckOut" method="post" class="last">
                <fieldset>
                    ...
                    <input type ="hidden" name="pagename" value ="CheckOut" />
					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<%
							if(name==null){%>
								<li><a href="login.jsp?pagename=Single">Login</a></li> 
								<li><a href="login.jsp?pagename=Single">Sign Up</a></li>
								<%}else{%>
									<li>Welcome <%=name %></li> 
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="indexnew.jsp"><span>Grocery</span> zappy </a></h1>
			</div>
			<!-- <div class="w3ls_logo_products_left1">
				<ul class="special_items">
					<li><a href="events.html">Events</a><i>/</i></li>
					<li><a href="about.html">About Us</a><i>/</i></li>
					<li><a href="indexnew.jsp">Best Deals</a><i>/</i></li>
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i>mustafaali784@gmail.com<a href="mailto:mustafaali784@gmail.com"></a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- banner -->
	<div class="banner">
	 ...
	 -->	<div class="w3l_banner_nav_right">
		<%ArrayList<ZappyBean> al=(ArrayList<ZappyBean>)request.getAttribute("data"); 
		for(ZappyBean b : al){
			%>
			...
			<div class="agileinfo_single">
				<h5><%=b.getProductName() %> <%=b.getWeight() %></h5>
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="images/<%=b.getImage()%>" alt=" " class="img-responsive" style="width:400px;height:300px;" />
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="w3agile_description">
						<h4>Description :</h4>
						<p><%=b.getDiscription() %></p>
					</div>
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4><%=b.getRate()%> Rs<span>0 Rs</span></h4>
						</div>
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="Addtocart" method="post">
								<fieldset>
									...
									<input type="hidden" name="item_name" value="<%=b.getProductName() %>" />
									<input type="hidden" name="amount" value="<%=b.getRate() %>" />
									<input type="hidden" name="discount_amount" value="10%" />
									<input type="hidden" name="pagename" value="Single" />
...
<!-- //banner -->
<!-- brands -->
<!-- <div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_popular"></div> -->
<!-- //brands -->
<!-- newsletter -->
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list"><li><a href="products.html">Branded Foods</a></li>
					<li><a href="household.html">Households</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
