...
<tr><th>Product_id</th><th>Product_Name</th><th>Category</th><th>Price</th><th>Weight</th><th>Discription</th><th>Image</th><th>Delete</th></tr>
<%
ArrayList<ZappyBean> list; 
list = (ArrayList<ZappyBean>)request.getAttribute("products");

for(ZappyBean b : list){
%>
<tr>
<td><%out.println(b.getPid()); %></td>
<td><%out.println(b.getProductName()); %></td>
<td><%out.println(b.getCategory()); %></td>
<td><%out.println(b.getRate()); %></td>
<td><%out.println(b.getWeight()); %></td>
<td><%out.println(b.getDiscription()); %></td>
<td><img src="images/<%=b.getImage()%>" height="50" width="50"/></td>
<td><a href ="Delete?pid=<%out.println(b.getPid());%>" onclick="return confirm('You Want To Remove The Product From The Cart')" >Delete</a></td>
<td><a href ="Update?pid=<%out.println(b.getPid());%>">Update</a></td>
</tr>
<%
}
%>
