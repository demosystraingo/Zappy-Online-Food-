	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="#"><span>Grocery</span>zappy</a></h1>
			</div>
			...
			<!-- <div class="w3ls_logo_products_center">
				...
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<span id = "confirm" ></span>
					  ...
					  <input type="Password" id = "opass" name="opwd" placeholder="Enter Old Password" required=" ">
					  <input type="Password" id = "pass" name="npwd" placeholder="Enter New Password" required=" ">
					  <input type="Password" id = "cpass" placeholder="Re-Type Password" onblur="show()" required >
