...
<!-- about -->
		<div class="privacy about">
			<h3>My Orders</h3>
			<%ArrayList<OrderBean> al =(ArrayList<OrderBean>)request.getAttribute("data");
			for(OrderBean b : al){
			%>
			
			<div class="agile_about_grids">
				<div class="col-md-6 agile_about_grid_right">
					<a href = "Single?pid=<%=b.getPid()%>"><img id="example" src="images/<%=b.getImage()%>" alt=" " class="img-responsive" /></a>
				</div>
				<div class="col-md-6 agile_about_grid_left">
					<ol>
						<li>Order-Id :- <%=b.getOid()%></li>
						<li>Quantity :- <%=b.getQuantity()%></li>
						<li>Amount :- <%=b.getAmount()%></li>
						<%if(b.getStatus().equals("0")){ %>
						<li>Status :- Pending</li>
						<%}else if(b.getStatus().equals("1")){ %>
						<li>Status :- Dispatch</li>
						<%}else if(b.getStatus().equals("2")){ %>
						<li>Status :- Delivered</li>
						<%}else if (b.getStatus().equals("3")){%>
						<li>Status :- Not Available</li>
						<%} %>
						<li>Order_date :- <%=b.getDate()%></li>
					</ol>
				</div>
				<div class="clearfix"> </div>
			</div>
